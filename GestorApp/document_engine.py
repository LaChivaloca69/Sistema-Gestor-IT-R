...
def valores_desde_orden(orden):
    ...
    valores = {
        ...
        "proveedor_razon_social": (proveedor.razon_social or "") if proveedor else "",
        "proveedor_rfc": (proveedor.rfc or "") if proveedor else "",
        "proveedor_codigo": (proveedor.codigo_interno or "") if proveedor else "",
        ...
        "proveedor_direccion": (proveedor.direccion or "") if proveedor else "",
        "proveedor_ciudad": (proveedor.ciudad or "") if proveedor else "",
        "proveedor_estado": (proveedor.estado or "") if proveedor else "",
        "proveedor_cp": (proveedor.codigo_postal or "") if proveedor else "",
        "proveedor_sitio_web": (proveedor.sitio_web or "") if proveedor else "",
...
def valores_desde_payload(payload):
    ...
    valores = {
        ...
        "proveedor_razon_social": _txt("proveedor_razon_social"),
        "proveedor_rfc": _txt("proveedor_rfc"),
        "proveedor_codigo": _txt("proveedor_codigo"),
        "proveedor_contacto": _txt("proveedor_contacto"),
        "proveedor_telefono": _txt("proveedor_telefono"),
        "proveedor_email": _txt("proveedor_email"),
        "proveedor_direccion": _txt("proveedor_direccion"),
        "proveedor_ciudad": _txt("proveedor_ciudad"),
        "proveedor_estado": _txt("proveedor_estado"),
        "proveedor_cp": _txt("proveedor_cp"),
        "proveedor_sitio_web": _txt("proveedor_sitio_web"),
