...
_MODULE = {
    ...
    "inventario_importar": ("Inventario", None, "Importar inventario", "equipo_dashboard"),
    "inventario_importar_preview": ("Inventario", None, "Vista previa", "inventario_importar"),
    "inventario_importar_confirmar": ("Inventario", None, "Confirmar importacion", "inventario_importar_preview"),
