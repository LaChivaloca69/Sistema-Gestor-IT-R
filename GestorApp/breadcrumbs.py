...
_MODULE = {
    ...
    "edificio_toggle_activo": ("Organizacion", None, "Activar/desactivar", "edificio_list"),
    ...
    "zonaedificio_toggle_activo": ("Organizacion", None, "Activar/desactivar", "zonaedificio_list"),
